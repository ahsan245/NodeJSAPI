...
async function getComplain(params, callback) {
    ...
    complain
        .find(condition, "complainCheckList complainStatus complainName complainDescription complainCategory userAddress userContact complainImage longitude latitude completeUpdate techComment refBill paymentStatus")
